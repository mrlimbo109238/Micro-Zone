    ...
    CO_CREATORS = [
        {
            ...
            "color":    "#ffd166",
            "message":  _(
                "Привет Саш, я очень рад что ты зашёл в игру, для меня "
                "это как знак уважение, спасибо тебе бро, что дариш мне "
                "такие не забываемые моменты, с уважением Лимба."
            ),
        },
        {
            "name":     "Алина",
            ...
            "message":  _(
                ...
                "Алина мне не передать слова благодарности которые ты "
                "для меня сделала, ты лучший юный блогер в моем ютубе, "
        ...
        },
        {
            ...
            "color":    "#7ee0ff",
            "message":  _(
                "Привет, я не конечно не уверен что ты зашёл сюда  но "
                "если видишь это сообщение и я его вижу в твоём ролике, "
                "знай ты лучший, мне не передать слова благодарности что "
                "ты для меня сделал, да есть грехи от меня, что я какой "
                "месяц тебя не смотрю, поверь на это есть весомые причины, "
                "надеюсь ты не обижен, с уважением Лимба."
            ),
        },
    ]
